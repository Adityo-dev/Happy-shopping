      ...
      <div className={styles.wrapper}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
          ...
          <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
            ...
            <g id="round-conf">
              <path
                className={((styles.cls1, styles.c1), styles.circle)}
              ...
              />
              <path
                className={(styles.cls1, styles.c2, styles.circle)}
              ...
              />
              <path
                className={(styles.cls1, styles.c3, styles.circle)}
              ...
              />
              <path
                className={((styles.cls1, styles.c4), styles.circle)}
              ...
              />
              <path
                className={(styles.cls1, styles.c5, styles.circle)}
              ...
              />
              <path
                className={(styles.cls1, styles.c6, styles.circle)}
